  ...
  return (
    <div className='flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6'>
      <div
        ...
        <div className='relative inline-flex items-center cursor-pointer rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50'>
          Previous
        </div>
        <div
        ...
        <div>
          <p className='text-sm text-gray-700'>
            ...
            <span className='font-medium'>
              {page * ITEMS_PER_PAGE > totalItems ? totalItems : ITEMS_PER_PAGE}
            </span>{' '}
                ...
                <div className='mt-4 flex justify-between'>
                  <div>
                    ...
                    <p className='mt-1 text-sm text-gray-500'>
                      <StarIcon className='w-5 h-5 inline text-orange-300'></StarIcon>
