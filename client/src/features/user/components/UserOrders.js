      ...
      {orders.map((order) => (
        <div className='mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='border-t border-gray-200 px-4 py-6 sm:px-6'>
            <h1 className='text-3xl my-5 font-bold tracking-tight text-gray-900'>Order # {order.id}</h1>
            ...
            <div className='flex justify-between gap-x-6 py-5 px-5 border-solid border-2 border-gray-200'>
              ...
              <div className='hidden sm:flex sm:flex-col sm:items-end'>
                <p className='text-sm font-semibold leading-6 text-gray-500'>
                  Phone: {order.selectAddress?.number}
                </p>
                <p className='text-sm leading-6 text-gray-900'>Email: {order.selectAddress?.email}</p>
                <p className='text-sm leading-6 text-gray-900'>
                  Address: {order.selectAddress?.addressDetails}
                </p>
              </div>
            </div>
          </div>
